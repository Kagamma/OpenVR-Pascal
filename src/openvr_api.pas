...
begin;
  ...
  IVRSystem.GetProjectionRaw := GetProcedureAddress(Lib, 'GetProjectionRaw');
  IVRSystem.ComputeDistortion := GetProcedureAddress(Lib, 'ComputeDistortion');
  IVRSystem.GetEyeToHeadTransform := GetProcedureAddress(Lib, 'GetEyeToHeadTransform');
  IVRSystem.GetTimeSinceLastVsync := GetProcedureAddress(Lib, 'GetTimeSinceLastVsync');
  IVRSystem.GetD3D9AdapterIndex := GetProcedureAddress(Lib, 'GetD3D9AdapterIndex');
  IVRSystem.GetDXGIOutputInfo := GetProcedureAddress(Lib, 'GetDXGIOutputInfo');
  IVRSystem.GetOutputDevice := GetProcedureAddress(Lib, 'GetOutputDevice');
  ...
  IVRSystem.GetTrackedDeviceActivityLevel := GetProcedureAddress(Lib, 'GetTrackedDeviceActivityLevel');
  IVRSystem.ApplyTransform := GetProcedureAddress(Lib, 'ApplyTransform');
  IVRSystem.GetTrackedDeviceIndexForControllerRole := GetProcedureAddress(Lib, 'GetTrackedDeviceIndexForControllerRole');
  IVRSystem.GetControllerRoleForTrackedDeviceIndex := GetProcedureAddress(Lib, 'GetControllerRoleForTrackedDeviceIndex');
  IVRSystem.GetTrackedDeviceClass := GetProcedureAddress(Lib, 'GetTrackedDeviceClass');
  IVRSystem.IsTrackedDeviceConnected := GetProcedureAddress(Lib, 'IsTrackedDeviceConnected');
  IVRSystem.GetBoolTrackedDeviceProperty := GetProcedureAddress(Lib, 'GetBoolTrackedDeviceProperty');
  IVRSystem.GetFloatTrackedDeviceProperty := GetProcedureAddress(Lib, 'GetFloatTrackedDeviceProperty');
  IVRSystem.GetInt32TrackedDeviceProperty := GetProcedureAddress(Lib, 'GetInt32TrackedDeviceProperty');
  IVRSystem.GetUint64TrackedDeviceProperty := GetProcedureAddress(Lib, 'GetUint64TrackedDeviceProperty');
  IVRSystem.GetMatrix34TrackedDeviceProperty := GetProcedureAddress(Lib, 'GetMatrix34TrackedDeviceProperty');
  IVRSystem.GetArrayTrackedDeviceProperty := GetProcedureAddress(Lib, 'GetArrayTrackedDeviceProperty');
  IVRSystem.GetStringTrackedDeviceProperty := GetProcedureAddress(Lib, 'GetStringTrackedDeviceProperty');
  IVRSystem.GetPropErrorNameFromEnum := GetProcedureAddress(Lib, 'GetPropErrorNameFromEnum');
  IVRSystem.PollNextEvent := GetProcedureAddress(Lib, 'PollNextEvent');
  IVRSystem.PollNextEventWithPose := GetProcedureAddress(Lib, 'PollNextEventWithPose');
  IVRSystem.GetEventTypeNameFromEnum := GetProcedureAddress(Lib, 'GetEventTypeNameFromEnum');
  IVRSystem.GetHiddenAreaMesh := GetProcedureAddress(Lib, 'GetHiddenAreaMesh');
  IVRSystem.GetControllerState := GetProcedureAddress(Lib, 'GetControllerState');
  IVRSystem.GetControllerStateWithPose := GetProcedureAddress(Lib, 'GetControllerStateWithPose');
  IVRSystem.TriggerHapticPulse := GetProcedureAddress(Lib, 'TriggerHapticPulse');
  IVRSystem.GetButtonIdNameFromEnum := GetProcedureAddress(Lib, 'GetButtonIdNameFromEnum');
  IVRSystem.GetControllerAxisTypeNameFromEnum := GetProcedureAddress(Lib, 'GetControllerAxisTypeNameFromEnum');
  IVRSystem.IsInputAvailable := GetProcedureAddress(Lib, 'IsInputAvailable');
  IVRSystem.IsSteamVRDrawingControllers := GetProcedureAddress(Lib, 'IsSteamVRDrawingControllers');
  IVRSystem.ShouldApplicationPause := GetProcedureAddress(Lib, 'ShouldApplicationPause');
  IVRSystem.ShouldApplicationReduceRenderingWork := GetProcedureAddress(Lib, 'ShouldApplicationReduceRenderingWork');
  IVRSystem.PerformFirmwareUpdate := GetProcedureAddress(Lib, 'PerformFirmwareUpdate');
  IVRSystem.AcknowledgeQuit_Exiting := GetProcedureAddress(Lib, 'AcknowledgeQuit_Exiting');
  IVRSystem.GetAppContainerFilePaths := GetProcedureAddress(Lib, 'GetAppContainerFilePaths');
  IVRSystem.GetRuntimeVersion := GetProcedureAddress(Lib, 'GetRuntimeVersion');

  IVRExtendedDisplay.GetWindowBounds := GetProcedureAddress(Lib, 'GetWindowBounds');
  IVRExtendedDisplay.GetEyeOutputViewport := GetProcedureAddress(Lib, 'GetEyeOutputViewport');
  IVRExtendedDisplay.GetDXGIOutputInfo := GetProcedureAddress(Lib, 'GetDXGIOutputInfo');

  IVRTrackedCamera.GetCameraErrorNameFromEnum := GetProcedureAddress(Lib, 'GetCameraErrorNameFromEnum');
  IVRTrackedCamera.HasCamera := GetProcedureAddress(Lib, 'HasCamera');
  IVRTrackedCamera.GetCameraFrameSize := GetProcedureAddress(Lib, 'GetCameraFrameSize');
  IVRTrackedCamera.GetCameraIntrinsics := GetProcedureAddress(Lib, 'GetCameraIntrinsics');
  IVRTrackedCamera.GetCameraProjection := GetProcedureAddress(Lib, 'GetCameraProjection');
  IVRTrackedCamera.AcquireVideoStreamingService := GetProcedureAddress(Lib, 'AcquireVideoStreamingService');
  IVRTrackedCamera.ReleaseVideoStreamingService := GetProcedureAddress(Lib, 'ReleaseVideoStreamingService');
  IVRTrackedCamera.GetVideoStreamFrameBuffer := GetProcedureAddress(Lib, 'GetVideoStreamFrameBuffer');
  IVRTrackedCamera.GetVideoStreamTextureSize := GetProcedureAddress(Lib, 'GetVideoStreamTextureSize');
  IVRTrackedCamera.GetVideoStreamTextureD3D11 := GetProcedureAddress(Lib, 'GetVideoStreamTextureD3D11');
  IVRTrackedCamera.GetVideoStreamTextureGL := GetProcedureAddress(Lib, 'GetVideoStreamTextureGL');
  IVRTrackedCamera.ReleaseVideoStreamTextureGL := GetProcedureAddress(Lib, 'ReleaseVideoStreamTextureGL');
  IVRTrackedCamera.SetCameraTrackingSpace := GetProcedureAddress(Lib, 'SetCameraTrackingSpace');
  IVRTrackedCamera.GetCameraTrackingSpace := GetProcedureAddress(Lib, 'GetCameraTrackingSpace');

  IVRApplications.AddApplicationManifest := GetProcedureAddress(Lib, 'AddApplicationManifest');
  IVRApplications.RemoveApplicationManifest := GetProcedureAddress(Lib, 'RemoveApplicationManifest');
  IVRApplications.IsApplicationInstalled := GetProcedureAddress(Lib, 'IsApplicationInstalled');
  IVRApplications.GetApplicationCount := GetProcedureAddress(Lib, 'GetApplicationCount');
  IVRApplications.GetApplicationKeyByIndex := GetProcedureAddress(Lib, 'GetApplicationKeyByIndex');
  IVRApplications.GetApplicationKeyByProcessId := GetProcedureAddress(Lib, 'GetApplicationKeyByProcessId');
  IVRApplications.LaunchApplication := GetProcedureAddress(Lib, 'LaunchApplication');
  IVRApplications.LaunchTemplateApplication := GetProcedureAddress(Lib, 'LaunchTemplateApplication');
  IVRApplications.LaunchApplicationFromMimeType := GetProcedureAddress(Lib, 'LaunchApplicationFromMimeType');
  IVRApplications.LaunchDashboardOverlay := GetProcedureAddress(Lib, 'LaunchDashboardOverlay');
  IVRApplications.CancelApplicationLaunch := GetProcedureAddress(Lib, 'CancelApplicationLaunch');
  IVRApplications.IdentifyApplication := GetProcedureAddress(Lib, 'IdentifyApplication');
  IVRApplications.GetApplicationProcessId := GetProcedureAddress(Lib, 'GetApplicationProcessId');
  IVRApplications.GetApplicationsErrorNameFromEnum := GetProcedureAddress(Lib, 'GetApplicationsErrorNameFromEnum');
  IVRApplications.GetApplicationPropertyString := GetProcedureAddress(Lib, 'GetApplicationPropertyString');
  IVRApplications.GetApplicationPropertyBool := GetProcedureAddress(Lib, 'GetApplicationPropertyBool');
  IVRApplications.GetApplicationPropertyUint64 := GetProcedureAddress(Lib, 'GetApplicationPropertyUint64');
  IVRApplications.SetApplicationAutoLaunch := GetProcedureAddress(Lib, 'SetApplicationAutoLaunch');
  IVRApplications.GetApplicationAutoLaunch := GetProcedureAddress(Lib, 'GetApplicationAutoLaunch');
  IVRApplications.SetDefaultApplicationForMimeType := GetProcedureAddress(Lib, 'SetDefaultApplicationForMimeType');
  IVRApplications.GetDefaultApplicationForMimeType := GetProcedureAddress(Lib, 'GetDefaultApplicationForMimeType');
  IVRApplications.GetApplicationSupportedMimeTypes := GetProcedureAddress(Lib, 'GetApplicationSupportedMimeTypes');
  IVRApplications.GetApplicationsThatSupportMimeType := GetProcedureAddress(Lib, 'GetApplicationsThatSupportMimeType');
  IVRApplications.GetApplicationLaunchArguments := GetProcedureAddress(Lib, 'GetApplicationLaunchArguments');
  IVRApplications.GetStartingApplication := GetProcedureAddress(Lib, 'GetStartingApplication');
  IVRApplications.GetSceneApplicationState := GetProcedureAddress(Lib, 'GetSceneApplicationState');
  IVRApplications.PerformApplicationPrelaunchCheck := GetProcedureAddress(Lib, 'PerformApplicationPrelaunchCheck');
  IVRApplications.GetSceneApplicationStateNameFromEnum := GetProcedureAddress(Lib, 'GetSceneApplicationStateNameFromEnum');
  IVRApplications.LaunchInternalProcess := GetProcedureAddress(Lib, 'LaunchInternalProcess');
  IVRApplications.GetCurrentSceneProcessId := GetProcedureAddress(Lib, 'GetCurrentSceneProcessId');

  IVRChaperone.GetCalibrationState := GetProcedureAddress(Lib, 'GetCalibrationState');
  IVRChaperone.GetPlayAreaSize := GetProcedureAddress(Lib, 'GetPlayAreaSize');
  IVRChaperone.GetPlayAreaRect := GetProcedureAddress(Lib, 'GetPlayAreaRect');
  IVRChaperone.ReloadInfo := GetProcedureAddress(Lib, 'ReloadInfo');
  IVRChaperone.SetSceneColor := GetProcedureAddress(Lib, 'SetSceneColor');
  ...
  IVRChaperoneSetup.GetWorkingPlayAreaSize := GetProcedureAddress(Lib, 'GetWorkingPlayAreaSize');
  IVRChaperoneSetup.GetWorkingPlayAreaRect := GetProcedureAddress(Lib, 'GetWorkingPlayAreaRect');
  IVRChaperoneSetup.GetWorkingCollisionBoundsInfo := GetProcedureAddress(Lib, 'GetWorkingCollisionBoundsInfo');
  IVRChaperoneSetup.GetLiveCollisionBoundsInfo := GetProcedureAddress(Lib, 'GetLiveCollisionBoundsInfo');
  IVRChaperoneSetup.GetWorkingSeatedZeroPoseToRawTrackingPose := GetProcedureAddress(Lib, 'GetWorkingSeatedZeroPoseToRawTrackingPose');
  IVRChaperoneSetup.GetWorkingStandingZeroPoseToRawTrackingPose := GetProcedureAddress(Lib, 'GetWorkingStandingZeroPoseToRawTrackingPose');
  IVRChaperoneSetup.SetWorkingPlayAreaSize := GetProcedureAddress(Lib, 'SetWorkingPlayAreaSize');
  IVRChaperoneSetup.SetWorkingCollisionBoundsInfo := GetProcedureAddress(Lib, 'SetWorkingCollisionBoundsInfo');
  IVRChaperoneSetup.SetWorkingPerimeter := GetProcedureAddress(Lib, 'SetWorkingPerimeter');
  IVRChaperoneSetup.SetWorkingSeatedZeroPoseToRawTrackingPose := GetProcedureAddress(Lib, 'SetWorkingSeatedZeroPoseToRawTrackingPose');
  IVRChaperoneSetup.SetWorkingStandingZeroPoseToRawTrackingPose := GetProcedureAddress(Lib, 'SetWorkingStandingZeroPoseToRawTrackingPose');
  IVRChaperoneSetup.ReloadFromDisk := GetProcedureAddress(Lib, 'ReloadFromDisk');
  IVRChaperoneSetup.GetLiveSeatedZeroPoseToRawTrackingPose := GetProcedureAddress(Lib, 'GetLiveSeatedZeroPoseToRawTrackingPose');
  IVRChaperoneSetup.ExportLiveToBuffer := GetProcedureAddress(Lib, 'ExportLiveToBuffer');
  IVRChaperoneSetup.ImportFromBufferToWorking := GetProcedureAddress(Lib, 'ImportFromBufferToWorking');
  IVRChaperoneSetup.ShowWorkingSetPreview := GetProcedureAddress(Lib, 'ShowWorkingSetPreview');
  IVRChaperoneSetup.HideWorkingSetPreview := GetProcedureAddress(Lib, 'HideWorkingSetPreview');
  IVRChaperoneSetup.RoomSetupStarting := GetProcedureAddress(Lib, 'RoomSetupStarting');

  IVRCompositor.SetTrackingSpace := GetProcedureAddress(Lib, 'SetTrackingSpace');
  IVRCompositor.GetTrackingSpace := GetProcedureAddress(Lib, 'GetTrackingSpace');
  IVRCompositor.WaitGetPoses := GetProcedureAddress(Lib, 'WaitGetPoses');
  IVRCompositor.GetLastPoses := GetProcedureAddress(Lib, 'GetLastPoses');
  IVRCompositor.GetLastPoseForTrackedDeviceIndex := GetProcedureAddress(Lib, 'GetLastPoseForTrackedDeviceIndex');
  IVRCompositor.Submit := GetProcedureAddress(Lib, 'Submit');
  IVRCompositor.ClearLastSubmittedFrame := GetProcedureAddress(Lib, 'ClearLastSubmittedFrame');
  IVRCompositor.PostPresentHandoff := GetProcedureAddress(Lib, 'PostPresentHandoff');
  IVRCompositor.GetFrameTiming := GetProcedureAddress(Lib, 'GetFrameTiming');
  IVRCompositor.GetFrameTimings := GetProcedureAddress(Lib, 'GetFrameTimings');
  IVRCompositor.GetFrameTimeRemaining := GetProcedureAddress(Lib, 'GetFrameTimeRemaining');
  IVRCompositor.GetCumulativeStats := GetProcedureAddress(Lib, 'GetCumulativeStats');
  IVRCompositor.FadeToColor := GetProcedureAddress(Lib, 'FadeToColor');
  IVRCompositor.GetCurrentFadeColor := GetProcedureAddress(Lib, 'GetCurrentFadeColor');
  IVRCompositor.FadeGrid := GetProcedureAddress(Lib, 'FadeGrid');
  IVRCompositor.GetCurrentGridAlpha := GetProcedureAddress(Lib, 'GetCurrentGridAlpha');
  IVRCompositor.SetSkyboxOverride := GetProcedureAddress(Lib, 'SetSkyboxOverride');
  IVRCompositor.ClearSkyboxOverride := GetProcedureAddress(Lib, 'ClearSkyboxOverride');
  IVRCompositor.CompositorBringToFront := GetProcedureAddress(Lib, 'CompositorBringToFront');
  IVRCompositor.CompositorGoToBack := GetProcedureAddress(Lib, 'CompositorGoToBack');
  IVRCompositor.CompositorQuit := GetProcedureAddress(Lib, 'CompositorQuit');
  IVRCompositor.IsFullscreen := GetProcedureAddress(Lib, 'IsFullscreen');
  IVRCompositor.GetCurrentSceneFocusProcess := GetProcedureAddress(Lib, 'GetCurrentSceneFocusProcess');
  IVRCompositor.GetLastFrameRenderer := GetProcedureAddress(Lib, 'GetLastFrameRenderer');
  IVRCompositor.CanRenderScene := GetProcedureAddress(Lib, 'CanRenderScene');
  IVRCompositor.ShowMirrorWindow := GetProcedureAddress(Lib, 'ShowMirrorWindow');
  IVRCompositor.HideMirrorWindow := GetProcedureAddress(Lib, 'HideMirrorWindow');
  IVRCompositor.IsMirrorWindowVisible := GetProcedureAddress(Lib, 'IsMirrorWindowVisible');
  IVRCompositor.CompositorDumpImages := GetProcedureAddress(Lib, 'CompositorDumpImages');
  IVRCompositor.ShouldAppRenderWithLowResources := GetProcedureAddress(Lib, 'ShouldAppRenderWithLowResources');
  IVRCompositor.ForceInterleavedReprojectionOn := GetProcedureAddress(Lib, 'ForceInterleavedReprojectionOn');
  IVRCompositor.ForceReconnectProcess := GetProcedureAddress(Lib, 'ForceReconnectProcess');
  IVRCompositor.SuspendRendering := GetProcedureAddress(Lib, 'SuspendRendering');
  IVRCompositor.GetMirrorTextureD3D11 := GetProcedureAddress(Lib, 'GetMirrorTextureD3D11');
  IVRCompositor.ReleaseMirrorTextureD3D11 := GetProcedureAddress(Lib, 'ReleaseMirrorTextureD3D11');
  IVRCompositor.GetMirrorTextureGL := GetProcedureAddress(Lib, 'GetMirrorTextureGL');
  IVRCompositor.ReleaseSharedGLTexture := GetProcedureAddress(Lib, 'ReleaseSharedGLTexture');
  IVRCompositor.LockGLSharedTextureForAccess := GetProcedureAddress(Lib, 'LockGLSharedTextureForAccess');
  IVRCompositor.UnlockGLSharedTextureForAccess := GetProcedureAddress(Lib, 'UnlockGLSharedTextureForAccess');
  IVRCompositor.GetVulkanInstanceExtensionsRequired := GetProcedureAddress(Lib, 'GetVulkanInstanceExtensionsRequired');
  IVRCompositor.GetVulkanDeviceExtensionsRequired := GetProcedureAddress(Lib, 'GetVulkanDeviceExtensionsRequired');
  IVRCompositor.SetExplicitTimingMode := GetProcedureAddress(Lib, 'SetExplicitTimingMode');
  IVRCompositor.SubmitExplicitTimingData := GetProcedureAddress(Lib, 'SubmitExplicitTimingData');
  IVRCompositor.IsMotionSmoothingEnabled := GetProcedureAddress(Lib, 'IsMotionSmoothingEnabled');
  IVRCompositor.IsMotionSmoothingSupported := GetProcedureAddress(Lib, 'IsMotionSmoothingSupported');
  IVRCompositor.IsCurrentSceneFocusAppLoading := GetProcedureAddress(Lib, 'IsCurrentSceneFocusAppLoading');
  IVRCompositor.SetStageOverride_Async := GetProcedureAddress(Lib, 'SetStageOverride_Async');
  IVRCompositor.ClearStageOverride := GetProcedureAddress(Lib, 'ClearStageOverride');
  IVRCompositor.GetCompositorBenchmarkResults := GetProcedureAddress(Lib, 'GetCompositorBenchmarkResults');
  IVRCompositor.GetLastPosePredictionIDs := GetProcedureAddress(Lib, 'GetLastPosePredictionIDs');
  IVRCompositor.GetPosesForFrame := GetProcedureAddress(Lib, 'GetPosesForFrame');

  IVROverlay.FindOverlay := GetProcedureAddress(Lib, 'FindOverlay');
  IVROverlay.CreateOverlay := GetProcedureAddress(Lib, 'CreateOverlay');
  IVROverlay.DestroyOverlay := GetProcedureAddress(Lib, 'DestroyOverlay');
  IVROverlay.GetOverlayKey := GetProcedureAddress(Lib, 'GetOverlayKey');
  IVROverlay.GetOverlayName := GetProcedureAddress(Lib, 'GetOverlayName');
  IVROverlay.SetOverlayName := GetProcedureAddress(Lib, 'SetOverlayName');
  IVROverlay.GetOverlayImageData := GetProcedureAddress(Lib, 'GetOverlayImageData');
  IVROverlay.GetOverlayErrorNameFromEnum := GetProcedureAddress(Lib, 'GetOverlayErrorNameFromEnum');
  IVROverlay.SetOverlayRenderingPid := GetProcedureAddress(Lib, 'SetOverlayRenderingPid');
  IVROverlay.GetOverlayRenderingPid := GetProcedureAddress(Lib, 'GetOverlayRenderingPid');
  IVROverlay.SetOverlayFlag := GetProcedureAddress(Lib, 'SetOverlayFlag');
  IVROverlay.GetOverlayFlag := GetProcedureAddress(Lib, 'GetOverlayFlag');
  IVROverlay.GetOverlayFlags := GetProcedureAddress(Lib, 'GetOverlayFlags');
  IVROverlay.SetOverlayColor := GetProcedureAddress(Lib, 'SetOverlayColor');
  IVROverlay.GetOverlayColor := GetProcedureAddress(Lib, 'GetOverlayColor');
  IVROverlay.SetOverlayAlpha := GetProcedureAddress(Lib, 'SetOverlayAlpha');
  IVROverlay.GetOverlayAlpha := GetProcedureAddress(Lib, 'GetOverlayAlpha');
  IVROverlay.SetOverlayTexelAspect := GetProcedureAddress(Lib, 'SetOverlayTexelAspect');
  IVROverlay.GetOverlayTexelAspect := GetProcedureAddress(Lib, 'GetOverlayTexelAspect');
  IVROverlay.SetOverlaySortOrder := GetProcedureAddress(Lib, 'SetOverlaySortOrder');
  IVROverlay.GetOverlaySortOrder := GetProcedureAddress(Lib, 'GetOverlaySortOrder');
  IVROverlay.SetOverlayWidthInMeters := GetProcedureAddress(Lib, 'SetOverlayWidthInMeters');
  IVROverlay.GetOverlayWidthInMeters := GetProcedureAddress(Lib, 'GetOverlayWidthInMeters');
  IVROverlay.SetOverlayCurvature := GetProcedureAddress(Lib, 'SetOverlayCurvature');
  IVROverlay.GetOverlayCurvature := GetProcedureAddress(Lib, 'GetOverlayCurvature');
  IVROverlay.SetOverlayTextureColorSpace := GetProcedureAddress(Lib, 'SetOverlayTextureColorSpace');
  IVROverlay.GetOverlayTextureColorSpace := GetProcedureAddress(Lib, 'GetOverlayTextureColorSpace');
  IVROverlay.SetOverlayTextureBounds := GetProcedureAddress(Lib, 'SetOverlayTextureBounds');
  IVROverlay.GetOverlayTextureBounds := GetProcedureAddress(Lib, 'GetOverlayTextureBounds');
  IVROverlay.GetOverlayTransformType := GetProcedureAddress(Lib, 'GetOverlayTransformType');
  IVROverlay.SetOverlayTransformAbsolute := GetProcedureAddress(Lib, 'SetOverlayTransformAbsolute');
  IVROverlay.GetOverlayTransformAbsolute := GetProcedureAddress(Lib, 'GetOverlayTransformAbsolute');
  IVROverlay.SetOverlayTransformTrackedDeviceRelative := GetProcedureAddress(Lib, 'SetOverlayTransformTrackedDeviceRelative');
  IVROverlay.GetOverlayTransformTrackedDeviceRelative := GetProcedureAddress(Lib, 'GetOverlayTransformTrackedDeviceRelative');
  IVROverlay.SetOverlayTransformTrackedDeviceComponent := GetProcedureAddress(Lib, 'SetOverlayTransformTrackedDeviceComponent');
  IVROverlay.GetOverlayTransformTrackedDeviceComponent := GetProcedureAddress(Lib, 'GetOverlayTransformTrackedDeviceComponent');
  IVROverlay.GetOverlayTransformOverlayRelative := GetProcedureAddress(Lib, 'GetOverlayTransformOverlayRelative');
  IVROverlay.SetOverlayTransformOverlayRelative := GetProcedureAddress(Lib, 'SetOverlayTransformOverlayRelative');
  IVROverlay.SetOverlayTransformCursor := GetProcedureAddress(Lib, 'SetOverlayTransformCursor');
  IVROverlay.GetOverlayTransformCursor := GetProcedureAddress(Lib, 'GetOverlayTransformCursor');
  IVROverlay.ShowOverlay := GetProcedureAddress(Lib, 'ShowOverlay');
  IVROverlay.HideOverlay := GetProcedureAddress(Lib, 'HideOverlay');
  IVROverlay.IsOverlayVisible := GetProcedureAddress(Lib, 'IsOverlayVisible');
  IVROverlay.GetTransformForOverlayCoordinates := GetProcedureAddress(Lib, 'GetTransformForOverlayCoordinates');
  IVROverlay.PollNextOverlayEvent := GetProcedureAddress(Lib, 'PollNextOverlayEvent');
  IVROverlay.GetOverlayInputMethod := GetProcedureAddress(Lib, 'GetOverlayInputMethod');
  IVROverlay.SetOverlayInputMethod := GetProcedureAddress(Lib, 'SetOverlayInputMethod');
  IVROverlay.GetOverlayMouseScale := GetProcedureAddress(Lib, 'GetOverlayMouseScale');
  IVROverlay.SetOverlayMouseScale := GetProcedureAddress(Lib, 'SetOverlayMouseScale');
  IVROverlay.ComputeOverlayIntersection := GetProcedureAddress(Lib, 'ComputeOverlayIntersection');
  IVROverlay.IsHoverTargetOverlay := GetProcedureAddress(Lib, 'IsHoverTargetOverlay');
  IVROverlay.SetOverlayIntersectionMask := GetProcedureAddress(Lib, 'SetOverlayIntersectionMask');
  IVROverlay.TriggerLaserMouseHapticVibration := GetProcedureAddress(Lib, 'TriggerLaserMouseHapticVibration');
  IVROverlay.SetOverlayCursor := GetProcedureAddress(Lib, 'SetOverlayCursor');
  IVROverlay.SetOverlayCursorPositionOverride := GetProcedureAddress(Lib, 'SetOverlayCursorPositionOverride');
  IVROverlay.ClearOverlayCursorPositionOverride := GetProcedureAddress(Lib, 'ClearOverlayCursorPositionOverride');
  IVROverlay.SetOverlayTexture := GetProcedureAddress(Lib, 'SetOverlayTexture');
  IVROverlay.ClearOverlayTexture := GetProcedureAddress(Lib, 'ClearOverlayTexture');
  IVROverlay.SetOverlayRaw := GetProcedureAddress(Lib, 'SetOverlayRaw');
  IVROverlay.SetOverlayFromFile := GetProcedureAddress(Lib, 'SetOverlayFromFile');
  IVROverlay.GetOverlayTexture := GetProcedureAddress(Lib, 'GetOverlayTexture');
  IVROverlay.ReleaseNativeOverlayHandle := GetProcedureAddress(Lib, 'ReleaseNativeOverlayHandle');
  IVROverlay.GetOverlayTextureSize := GetProcedureAddress(Lib, 'GetOverlayTextureSize');
  IVROverlay.CreateDashboardOverlay := GetProcedureAddress(Lib, 'CreateDashboardOverlay');
  IVROverlay.IsDashboardVisible := GetProcedureAddress(Lib, 'IsDashboardVisible');
  IVROverlay.IsActiveDashboardOverlay := GetProcedureAddress(Lib, 'IsActiveDashboardOverlay');
  IVROverlay.SetDashboardOverlaySceneProcess := GetProcedureAddress(Lib, 'SetDashboardOverlaySceneProcess');
  IVROverlay.GetDashboardOverlaySceneProcess := GetProcedureAddress(Lib, 'GetDashboardOverlaySceneProcess');
  IVROverlay.ShowDashboard := GetProcedureAddress(Lib, 'ShowDashboard');
  IVROverlay.GetPrimaryDashboardDevice := GetProcedureAddress(Lib, 'GetPrimaryDashboardDevice');
  IVROverlay.ShowKeyboard := GetProcedureAddress(Lib, 'ShowKeyboard');
  IVROverlay.ShowKeyboardForOverlay := GetProcedureAddress(Lib, 'ShowKeyboardForOverlay');
  IVROverlay.GetKeyboardText := GetProcedureAddress(Lib, 'GetKeyboardText');
  IVROverlay.HideKeyboard := GetProcedureAddress(Lib, 'HideKeyboard');
  IVROverlay.SetKeyboardTransformAbsolute := GetProcedureAddress(Lib, 'SetKeyboardTransformAbsolute');
  IVROverlay.SetKeyboardPositionForOverlay := GetProcedureAddress(Lib, 'SetKeyboardPositionForOverlay');
  IVROverlay.ShowMessageOverlay := GetProcedureAddress(Lib, 'ShowMessageOverlay');
  IVROverlay.CloseMessageOverlay := GetProcedureAddress(Lib, 'CloseMessageOverlay');

  IVROverlayView.AcquireOverlayView := GetProcedureAddress(Lib, 'AcquireOverlayView');
  IVROverlayView.ReleaseOverlayView := GetProcedureAddress(Lib, 'ReleaseOverlayView');
  IVROverlayView.PostOverlayEvent := GetProcedureAddress(Lib, 'PostOverlayEvent');
  IVROverlayView.IsViewingPermitted := GetProcedureAddress(Lib, 'IsViewingPermitted');

  IVRHeadsetView.SetHeadsetViewSize := GetProcedureAddress(Lib, 'SetHeadsetViewSize');
  IVRHeadsetView.GetHeadsetViewSize := GetProcedureAddress(Lib, 'GetHeadsetViewSize');
  IVRHeadsetView.SetHeadsetViewMode := GetProcedureAddress(Lib, 'SetHeadsetViewMode');
  IVRHeadsetView.GetHeadsetViewMode := GetProcedureAddress(Lib, 'GetHeadsetViewMode');
  IVRHeadsetView.SetHeadsetViewCropped := GetProcedureAddress(Lib, 'SetHeadsetViewCropped');
  IVRHeadsetView.GetHeadsetViewCropped := GetProcedureAddress(Lib, 'GetHeadsetViewCropped');
  IVRHeadsetView.GetHeadsetViewAspectRatio := GetProcedureAddress(Lib, 'GetHeadsetViewAspectRatio');
  IVRHeadsetView.SetHeadsetViewBlendRange := GetProcedureAddress(Lib, 'SetHeadsetViewBlendRange');
  IVRHeadsetView.GetHeadsetViewBlendRange := GetProcedureAddress(Lib, 'GetHeadsetViewBlendRange');

  IVRRenderModels.LoadRenderModel_Async := GetProcedureAddress(Lib, 'LoadRenderModel_Async');
  IVRRenderModels.FreeRenderModel := GetProcedureAddress(Lib, 'FreeRenderModel');
  IVRRenderModels.LoadTexture_Async := GetProcedureAddress(Lib, 'LoadTexture_Async');
  IVRRenderModels.FreeTexture := GetProcedureAddress(Lib, 'FreeTexture');
  IVRRenderModels.LoadTextureD3D11_Async := GetProcedureAddress(Lib, 'LoadTextureD3D11_Async');
  IVRRenderModels.LoadIntoTextureD3D11_Async := GetProcedureAddress(Lib, 'LoadIntoTextureD3D11_Async');
  IVRRenderModels.FreeTextureD3D11 := GetProcedureAddress(Lib, 'FreeTextureD3D11');
  IVRRenderModels.GetRenderModelName := GetProcedureAddress(Lib, 'GetRenderModelName');
  IVRRenderModels.GetRenderModelCount := GetProcedureAddress(Lib, 'GetRenderModelCount');
  IVRRenderModels.GetComponentCount := GetProcedureAddress(Lib, 'GetComponentCount');
  IVRRenderModels.GetComponentName := GetProcedureAddress(Lib, 'GetComponentName');
  IVRRenderModels.GetComponentButtonMask := GetProcedureAddress(Lib, 'GetComponentButtonMask');
  IVRRenderModels.GetComponentRenderModelName := GetProcedureAddress(Lib, 'GetComponentRenderModelName');
  IVRRenderModels.GetComponentStateForDevicePath := GetProcedureAddress(Lib, 'GetComponentStateForDevicePath');
  IVRRenderModels.GetComponentState := GetProcedureAddress(Lib, 'GetComponentState');
  IVRRenderModels.RenderModelHasComponent := GetProcedureAddress(Lib, 'RenderModelHasComponent');
  IVRRenderModels.GetRenderModelThumbnailURL := GetProcedureAddress(Lib, 'GetRenderModelThumbnailURL');
  IVRRenderModels.GetRenderModelOriginalPath := GetProcedureAddress(Lib, 'GetRenderModelOriginalPath');
  IVRRenderModels.GetRenderModelErrorNameFromEnum := GetProcedureAddress(Lib, 'GetRenderModelErrorNameFromEnum');

  IVRNotifications.CreateNotification := GetProcedureAddress(Lib, 'CreateNotification');
  IVRNotifications.RemoveNotification := GetProcedureAddress(Lib, 'RemoveNotification');

  IVRSettings.GetSettingsErrorNameFromEnum := GetProcedureAddress(Lib, 'GetSettingsErrorNameFromEnum');
  IVRSettings.SetBool := GetProcedureAddress(Lib, 'SetBool');
  IVRSettings.SetInt32 := GetProcedureAddress(Lib, 'SetInt32');
  IVRSettings.SetFloat := GetProcedureAddress(Lib, 'SetFloat');
  IVRSettings.SetString := GetProcedureAddress(Lib, 'SetString');
  IVRSettings.GetBool := GetProcedureAddress(Lib, 'GetBool');
  IVRSettings.GetInt32 := GetProcedureAddress(Lib, 'GetInt32');
  IVRSettings.GetFloat := GetProcedureAddress(Lib, 'GetFloat');
  IVRSettings.GetString := GetProcedureAddress(Lib, 'GetString');
  IVRSettings.RemoveSection := GetProcedureAddress(Lib, 'RemoveSection');
  IVRSettings.RemoveKeyInSection := GetProcedureAddress(Lib, 'RemoveKeyInSection');

  IVRScreenshots.RequestScreenshot := GetProcedureAddress(Lib, 'RequestScreenshot');
  IVRScreenshots.HookScreenshot := GetProcedureAddress(Lib, 'HookScreenshot');
  IVRScreenshots.GetScreenshotPropertyType := GetProcedureAddress(Lib, 'GetScreenshotPropertyType');
  IVRScreenshots.GetScreenshotPropertyFilename := GetProcedureAddress(Lib, 'GetScreenshotPropertyFilename');
  IVRScreenshots.UpdateScreenshotProgress := GetProcedureAddress(Lib, 'UpdateScreenshotProgress');
  IVRScreenshots.TakeStereoScreenshot := GetProcedureAddress(Lib, 'TakeStereoScreenshot');
  IVRScreenshots.SubmitScreenshot := GetProcedureAddress(Lib, 'SubmitScreenshot');

  IVRResources.LoadSharedResource := GetProcedureAddress(Lib, 'LoadSharedResource');
  IVRResources.GetResourceFullPath := GetProcedureAddress(Lib, 'GetResourceFullPath');

  IVRDriverManager.GetDriverCount := GetProcedureAddress(Lib, 'GetDriverCount');
  IVRDriverManager.GetDriverName := GetProcedureAddress(Lib, 'GetDriverName');
  IVRDriverManager.GetDriverHandle := GetProcedureAddress(Lib, 'GetDriverHandle');
  IVRDriverManager.IsEnabled := GetProcedureAddress(Lib, 'IsEnabled');

  IVRInput.SetActionManifestPath := GetProcedureAddress(Lib, 'SetActionManifestPath');
  IVRInput.GetActionSetHandle := GetProcedureAddress(Lib, 'GetActionSetHandle');
  IVRInput.GetActionHandle := GetProcedureAddress(Lib, 'GetActionHandle');
  IVRInput.GetInputSourceHandle := GetProcedureAddress(Lib, 'GetInputSourceHandle');
  IVRInput.UpdateActionState := GetProcedureAddress(Lib, 'UpdateActionState');
  IVRInput.GetDigitalActionData := GetProcedureAddress(Lib, 'GetDigitalActionData');
  IVRInput.GetAnalogActionData := GetProcedureAddress(Lib, 'GetAnalogActionData');
  IVRInput.GetPoseActionDataRelativeToNow := GetProcedureAddress(Lib, 'GetPoseActionDataRelativeToNow');
  IVRInput.GetPoseActionDataForNextFrame := GetProcedureAddress(Lib, 'GetPoseActionDataForNextFrame');
  IVRInput.GetSkeletalActionData := GetProcedureAddress(Lib, 'GetSkeletalActionData');
  IVRInput.GetDominantHand := GetProcedureAddress(Lib, 'GetDominantHand');
  IVRInput.SetDominantHand := GetProcedureAddress(Lib, 'SetDominantHand');
  IVRInput.GetBoneCount := GetProcedureAddress(Lib, 'GetBoneCount');
  IVRInput.GetBoneHierarchy := GetProcedureAddress(Lib, 'GetBoneHierarchy');
  IVRInput.GetBoneName := GetProcedureAddress(Lib, 'GetBoneName');
  IVRInput.GetSkeletalReferenceTransforms := GetProcedureAddress(Lib, 'GetSkeletalReferenceTransforms');
  IVRInput.GetSkeletalTrackingLevel := GetProcedureAddress(Lib, 'GetSkeletalTrackingLevel');
  IVRInput.GetSkeletalBoneData := GetProcedureAddress(Lib, 'GetSkeletalBoneData');
  IVRInput.GetSkeletalSummaryData := GetProcedureAddress(Lib, 'GetSkeletalSummaryData');
  IVRInput.GetSkeletalBoneDataCompressed := GetProcedureAddress(Lib, 'GetSkeletalBoneDataCompressed');
  IVRInput.DecompressSkeletalBoneData := GetProcedureAddress(Lib, 'DecompressSkeletalBoneData');
  IVRInput.TriggerHapticVibrationAction := GetProcedureAddress(Lib, 'TriggerHapticVibrationAction');
  IVRInput.GetActionOrigins := GetProcedureAddress(Lib, 'GetActionOrigins');
  IVRInput.GetOriginLocalizedName := GetProcedureAddress(Lib, 'GetOriginLocalizedName');
  IVRInput.GetOriginTrackedDeviceInfo := GetProcedureAddress(Lib, 'GetOriginTrackedDeviceInfo');
  IVRInput.GetActionBindingInfo := GetProcedureAddress(Lib, 'GetActionBindingInfo');
  IVRInput.ShowActionOrigins := GetProcedureAddress(Lib, 'ShowActionOrigins');
  IVRInput.ShowBindingsForActionSet := GetProcedureAddress(Lib, 'ShowBindingsForActionSet');
  IVRInput.GetComponentStateForBinding := GetProcedureAddress(Lib, 'GetComponentStateForBinding');
  IVRInput.IsUsingLegacyInput := GetProcedureAddress(Lib, 'IsUsingLegacyInput');
  IVRInput.OpenBindingUI := GetProcedureAddress(Lib, 'OpenBindingUI');
  IVRInput.GetBindingVariant := GetProcedureAddress(Lib, 'GetBindingVariant');

  IVRIOBuffer.Open := GetProcedureAddress(Lib, 'Open');
  IVRIOBuffer.Close := GetProcedureAddress(Lib, 'Close');
  IVRIOBuffer.Read := GetProcedureAddress(Lib, 'Read');
  IVRIOBuffer.Write := GetProcedureAddress(Lib, 'Write');
  IVRIOBuffer.PropertyContainer := GetProcedureAddress(Lib, 'PropertyContainer');
  IVRIOBuffer.HasReaders := GetProcedureAddress(Lib, 'HasReaders');

  IVRSpatialAnchors.CreateSpatialAnchorFromDescriptor := GetProcedureAddress(Lib, 'CreateSpatialAnchorFromDescriptor');
  IVRSpatialAnchors.CreateSpatialAnchorFromPose := GetProcedureAddress(Lib, 'CreateSpatialAnchorFromPose');
  IVRSpatialAnchors.GetSpatialAnchorPose := GetProcedureAddress(Lib, 'GetSpatialAnchorPose');
  IVRSpatialAnchors.GetSpatialAnchorDescriptor := GetProcedureAddress(Lib, 'GetSpatialAnchorDescriptor');

  IVRDebug.EmitVrProfilerEvent := GetProcedureAddress(Lib, 'EmitVrProfilerEvent');
  IVRDebug.BeginVrProfilerEvent := GetProcedureAddress(Lib, 'BeginVrProfilerEvent');
  IVRDebug.FinishVrProfilerEvent := GetProcedureAddress(Lib, 'FinishVrProfilerEvent');
  IVRDebug.DriverDebugRequest := GetProcedureAddress(Lib, 'DriverDebugRequest');

  IVRProperties.ReadPropertyBatch := GetProcedureAddress(Lib, 'ReadPropertyBatch');
  IVRProperties.WritePropertyBatch := GetProcedureAddress(Lib, 'WritePropertyBatch');
  IVRProperties.GetPropErrorNameFromEnum := GetProcedureAddress(Lib, 'GetPropErrorNameFromEnum');
  IVRProperties.TrackedDeviceToPropertyContainer := GetProcedureAddress(Lib, 'TrackedDeviceToPropertyContainer');

  IVRPaths.ReadPathBatch := GetProcedureAddress(Lib, 'ReadPathBatch');
  IVRPaths.WritePathBatch := GetProcedureAddress(Lib, 'WritePathBatch');
  IVRPaths.StringToHandle := GetProcedureAddress(Lib, 'StringToHandle');
  IVRPaths.HandleToString := GetProcedureAddress(Lib, 'HandleToString');

  IVRBlockQueue.Create := GetProcedureAddress(Lib, 'Create');
  IVRBlockQueue.Connect := GetProcedureAddress(Lib, 'Connect');
  IVRBlockQueue.Destroy := GetProcedureAddress(Lib, 'Destroy');
  IVRBlockQueue.AcquireWriteOnlyBlock := GetProcedureAddress(Lib, 'AcquireWriteOnlyBlock');
  IVRBlockQueue.ReleaseWriteOnlyBlock := GetProcedureAddress(Lib, 'ReleaseWriteOnlyBlock');
  IVRBlockQueue.WaitAndAcquireReadOnlyBlock := GetProcedureAddress(Lib, 'WaitAndAcquireReadOnlyBlock');
  IVRBlockQueue.AcquireReadOnlyBlock := GetProcedureAddress(Lib, 'AcquireReadOnlyBlock');
  IVRBlockQueue.ReleaseReadOnlyBlock := GetProcedureAddress(Lib, 'ReleaseReadOnlyBlock');
  IVRBlockQueue.QueueHasReader := GetProcedureAddress(Lib, 'QueueHasReader');
